...
//     configLineWeek
// );
//Dashboard Chart month wise order value
$.ajax({
    url:"/total_order_value_chart",
    type: "GET",
    async: false,
    data: {},
    success: function (response) {

        document.getElementById('overview').innerText = "Overview of "+response['year'];

        const labelsLineMonth = response['month'];
        const range = response['total_value']
...
//Dashboard Chart week wise order value
$.ajax({
    url:"/week_chart",
    type: "GET",
    async: false,
    ...
    success: function (response) {
        ...
        // document.getElementById('overview1').innerText = "Overview of Current Week";

        const labelsLineWeek = response['day'];
        const range = response['total_value']
...
//current year monthly total order
$.ajax({
    url:"/total_order_chart",
    type: "GET",
    async: false,
    data: {},
    success: function (response) {
        document.getElementById('year').innerText = "Year of "+response['year'];

        const label = response['month'];
        const range = response['total_order']
...
const labels = ["January", "", "March", "April", "May", "June", ""];
const data = {
    labels: labels,
    datasets: [
        {
...
// const labels_new = ["January", "", "March", "April", "May", "June", ""];
...
const myChartBar3 = new Chart(document.getElementById("chartBar3"), config3);
//End Mahfuj-13.03.22
