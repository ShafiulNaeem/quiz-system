...
if (!function_exists('areActiveRoutes')) {
    function areActiveRoutes(array $routes, $output = "menu_active")
    {
...
if (!function_exists('areActiveRouteSub')) {
    function areActiveRouteSub(array $routes, $output = "inner_active")
    {
        foreach ($routes as $route) {
            if (Route::currentRouteName() == $route) {
                return $output;
...
if (!function_exists('areActiveRouteShow')) {
    function areActiveRouteShow(array $routes, $output = "show")
    {
        foreach ($routes as $route) {
            if (Route::currentRouteName() == $route) {
                return $output;
...
if (!function_exists('getCountryList')) {
    function getCountryList($defaultCountry = "", $id = "", $name = "", $classes = "")
    {
        $countryArray = array(
        ...
        foreach($countryArray as $code => $country){
            ...
            $output .= "<option value='+".$country["code"]."' ".(($country["code"]==strtoupper($defaultCountry))?"selected":"")."> +".$country["code"]." (".$countryName.")</option>";
        }
